...
3. **A self-verifying phone-home**: Captain subscribes to the topic, assumes
   the read role, probes it, and only then does the deploy report success. A
...
is not yet activated, so a deploy currently completes the setup steps in your
